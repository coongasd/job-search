            ...
            <div>
                <ul className='navbar flex gap-5 justify-center'>
                    <Link to="/profile/setting">
                      <li className="cursor-pointer text-amber-600 relative border-b-amber-600 after:absolute after:bottom-0 after:h-0.5 after:left-0  after:bg-amber-600 hover:text-amber-600 hover:after:w-full">Thông tin cá nhân</li>
                    </Link>
                    <Link to="/profile/setting/workprofile"><li className="cursor-pointer relative text-black font-light after:absolute after:bottom-0 after:h-0.5 after:left-0  after:bg-amber-600 hover:text-amber-600 hover:after:w-full">Hồ sơ làm việc</li></Link>
