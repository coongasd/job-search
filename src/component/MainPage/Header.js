   ...
   <div className="sticky border-2 border-b-amber-600 z-50">
        <nav className='flex flex-row justify-between items-center'>
            ...
            <ul className="basis-4/6 flex items-center justify-center gap-8 font-medium">
              ...
              after:left-0 after:bottom-0 after:h-0.5 after:bg-amber-400 hover:after:w-full after:transition-all after:ease-in-out after:duration-300' onClick={toggle}>
                  Việc làm
                </a>
                {
                  isOpen && (
                    <div className=" absolute w-max top-17 pr-20 pl-2 rounded bg-white shadow-lg shadow-black">
                      <ul className="">
                        <li class=" py-5">
                          <a href="" class="flex gap-5 hover:text-amber-600 text-sm text-black">
                        ...
                        <li class="text-start py-5">
                          <a href="" class="flex gap-5 hover:text-amber-600 text-sm ">
